<#PSScriptInfo
Source - https://github.com/Mr-Tbone/Intune/blob/master/Intune-Set-PrimaryUsers.ps1
.SYNOPSIS
...
param(
    ...
    [string[]]$ExcludedNames = @('Testx12345'),
            ...
            try {
                ...
                do {
                    ...
                    try {
                        ...
                        Write-Verbose "$($script:GetTimestamp.Invoke()),Error,$($MyInvocation.MyCommand.Name),Request failed with error: $_"
                        #return $response
                        throw
                    }
                    if ($Method -eq 'POST') {
...
try {
    #Sign in to Graph
    try {
        $MgGraphAccessToken = Invoke-ConnectMgGraph -RequiredScopes $RequiredScopes
