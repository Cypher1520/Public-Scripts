...
function Write-Log {
    ...
    $logFilePath = "$($env:ProgramData)\AutopilotConfig\RemoveW10Bloatware.log"
...
Set-Content -Path "$($env:ProgramData)\AutopilotConfig\RemoveW10Bloatware.ps1.tag" -Value "Installed"