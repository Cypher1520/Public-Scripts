...
## Set the global variable(s) used throughout the script
	...
	[String]$Global:DefaultRegistryKey = "HKLM:\SOFTWARE\CityOfWinnipeg\BitLocker" ## <---- Change "CompanyName" to your own company name.
	...
	[DateTime]$Global:DefaultEventTime = "08/10/2025 00:00:00" ## <---- MM/dd/yyyy HH:mm:ss
