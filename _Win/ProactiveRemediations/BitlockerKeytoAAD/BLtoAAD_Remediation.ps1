# Remediate - Upload BitLocker Key to AAD
# https://blog.mindcore.dk/2022/12/migrate-bitlocker-recovery-keys-to-azure-ad-with-proactive-remediation/
# ----------------------------------------------
# Line 226 - Validate CompanyName (currently InformantSystems)
# ----------------------------------------------
...
[String]$Global:DefaultRegistryKey = "HKLM:\SOFTWARE\InformantSystems\BitLocker" ## <---- Change "CompanyName" to your own company name.
