...
.\Get-MeetingRoomStats.ps1 -RoomListSMTP "pool1-cgy@wolfmidstream.com" -From "01/01/2019" -To "5/31/2019" -ExchangeOnline -Verbose | Export-Csv .\export.csv -NoTypeInformation
